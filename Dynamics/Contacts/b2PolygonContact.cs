...
public class b2PolygonContact : b2Contact
{
	...
	{
		Debug.Assert(m_fixtureA.GetType() == b2Shape.Type.e_polygon);
	...
	{
		GlobalMembers.b2CollidePolygons(manifold, (b2PolygonShape)m_fixtureA.GetShape(), xfA, (b2PolygonShape)m_fixtureB.GetShape(), xfB);
	}
}
