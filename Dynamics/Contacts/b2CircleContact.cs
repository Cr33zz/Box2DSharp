...
public class b2CircleContact : b2Contact
{
	...
	{
		Debug.Assert(m_fixtureA.GetType() == b2Shape.Type.e_circle);
		Debug.Assert(m_fixtureB.GetType() == b2Shape.Type.e_circle);
	}
	...
	{
		GlobalMembers.b2CollideCircles(manifold, (b2CircleShape)m_fixtureA.GetShape(), xfA, (b2CircleShape)m_fixtureB.GetShape(), xfB);
	}
}
